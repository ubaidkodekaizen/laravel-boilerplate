...
<body class="bg-gradient-to-br from-indigo-50 via-purple-50 to-blue-50 min-h-screen flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
            ...
            <form action="{{ route('register') }}" method="POST" class="space-y-6">
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <button type="button" id="togglePasswordConfirmation" class="absolute right-3 top-1/2 transform -translate-y-1/2 text-gray-500 hover:text-indigo-600">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"></path>
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z"></path>
                            </svg>
                ...
                <div class="text-center">
                    <p class="text-sm text-gray-600">
                        ...
                        <a href="{{ route('login.form') }}" class="font-medium text-indigo-600 hover:text-indigo-800">
                            Sign in
                        </a>
                    </p>
                </div>
    ...
    <script>
        ...
        document.getElementById('togglePasswordConfirmation').addEventListener('click', () => togglePasswordVisibility('password_confirmation', 'togglePasswordConfirmation'));
    </script>
</body>
</html>
